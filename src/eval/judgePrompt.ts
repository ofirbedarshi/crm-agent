...
4) If input clearly contains client preferences (city / property_type / budget / entry_date), were they extracted reasonably?
5) If input is ambiguous or missing critical details, are clarification_questions present?
6) Are there invalid or unsupported fields inside action.data?
